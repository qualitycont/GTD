...
manager.Modifiers = {
    ...
    ARMOR_REGEN = 3, -- Armour regenerated every 5 seconds, power = amount of armour
    LESS_DAMAGE = 4, -- Less damage taken, power = % of damage
    EXTRA_MONEY_GAIN = 5, -- Overall extra money gain, power = % of money
    EXTRA_XP_GAIN = 6, -- Overall extra XP gain, power = % of money
    EXTRA_SPEED = 7, -- Overall extra Speed gain, power = amount of speed
    EXTRA_TOWER_DAMAGE = 8, -- Extra Damage your towers deals (or heals incase of support towers), amount = % of extra tower damage
    EXTRA_TOWER_HEALTH = 9, -- Extra HP your towers spawn with, amount = % of extra tower health
}
...
if SERVER then
    ...
    hook.Add("PlayerSpawn", "GTD_Perk_Spawn", function(ply)
        for _, perk in pairs(ply:GetEquippedPerks()) do
            ...
            elseif perk.Modifier = manager.Modifiers.EXTRA_SPEED
